...
const weatherSummaryImg = document.quvksdjjbcsikcbsrerySelector('.weather-summary-img')
...
function updateForecastsItems(weatherData)
{
    ...
    const forecastItem = `
                <div class="forecast-item">
                    ...
                    <h5 class="forecast-item-item">${Math.round(temp)} ℃</h5>
                </div>`
...
{
    [weatherInfoSection, searcchCitySection, notFoundSection].forEach(section => section.style.display = 'none')
